...
public class Device2BleCallback extends BleConnectCallback {

    private static final String TAG = "Device2BleCallback";
    ...
    public Device2BleCallback(BleMultiConnector bleMultiConnector) {
