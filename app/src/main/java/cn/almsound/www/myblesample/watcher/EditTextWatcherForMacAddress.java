package cn.almsound.www.myblesample.watcher;
...
public class EditTextWatcherForMacAddress implements TextWatcher {

    private static final String TAG = EditTextWatcherForMacAddress.class.getSimpleName();
    ...
    public EditTextWatcherForMacAddress(EditText editText) {
